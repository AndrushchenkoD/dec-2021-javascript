...
//
//     document.body.appendChild(divE);
//     divE.appendChild(divName);
//     divE.appendChild(divSurname);
//     divE.appendChild(divAge);
//     divE.appendChild(divInfo);
//     divE.appendChild(divPhoto);
// }
...
for (const coursesArrayEl of coursesArray) {
    let divE= document.createElement('div');

    let divTitle=document.createElement('div');
    divTitle.innerText=coursesArrayEl.title;

    let divMonthDuration=document.createElement('div');
    divMonthDuration.innerText=coursesArrayEl.monthDuration;

    let divHourDuration = document.createElement('div');
    divHourDuration.innerText= coursesArrayEl.hourDuration;

    let ulModules = document.createElement('ul');

    for (const ulModule of coursesArrayEl.modules) {
        let liModule = document.createElement('li');
        liModule.innerText=ulModule;
        ulModules.appendChild(liModule);
    }

    document.body.appendChild(divE);
    divE.appendChild(divTitle);
    divE.appendChild(divMonthDuration);
    divE.appendChild(divHourDuration);
    divE.appendChild(ulModules);
}